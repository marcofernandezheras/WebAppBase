...
namespace RepositoryLayer.Repositories
{
    ...
    public partial class RoleUpdateCommand : IUpdateCommand<RoleData>
    {
    	protected DataModelContainer _context;
    
    	public RoleUpdateCommand(DataModelContainer context)
    	{
    		_context = context;
    	}
    	...
    	public virtual async Task<CommandResult<RoleData>> Update(RoleData data)
    	{
            ...
            return new CommandResult<RoleData>(data, new RoleData(entity), rows > 0);
    	}
    }
}
